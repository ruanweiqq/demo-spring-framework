...
public class MyAspect {
	...
	@Pointcut("within(org.ruanwei.demo.springframework.core.aop.*)")
	public void myPointcut1() {
	}

	@Pointcut("execution(* *..AOP.say*(..))")
	...
	@DeclareParents(value = "org.ruanwei.demo.springframework.core.aop.GoodImpl", defaultImpl = HappyImpl.class)
	public static Happy mixin;
