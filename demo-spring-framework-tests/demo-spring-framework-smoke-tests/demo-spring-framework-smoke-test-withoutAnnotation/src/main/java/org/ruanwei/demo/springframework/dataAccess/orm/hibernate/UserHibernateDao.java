...
public class UserHibernateDao extends DefaultCrudDao<UserHibernateEntity, Integer> {
	...
	public void setUserTransactionnalHibernateDao(
			TransactionalDao<UserHibernateEntity> userTransactionnalHibernateDao) {
		this.userTransactionnalHibernateDao = userTransactionnalHibernateDao;
	}
